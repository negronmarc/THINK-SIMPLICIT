  ...
  return (
    <div id="fractional-container">
      <div id="guide" class="row justify-content-evenly">
        ...
        <a href="#revenue" class="col-3 fractional-menu">CHIEF REVENUE OFFICER</a>
        <a href="#strategy" class="col-3 fractional-menu">CHIEF STRATEGY OFFICER</a>
        <a href="#customer" class="col-3 fractional-menu">CHIEF CUSTOMER OFFICER</a>
      </div>
      <div>
      ...
      <div class="grey-container">
        ...
        <div class="row justify-content-evenly">
          <img src={womanMeeting} class="col-8 left-fractional-images" />
          <p class="col-4 fractional-text">
      ...
      <div class="blank-container">
        <h3 id="revenue" class="right-titles">CHIEF REVENUE OFFICER (CRO)</h3>
        <div class="row justify-content-evenly">
          <p class="col-4 fractional-text">
          ...
          <img src={highFive} class="col-8 right-fractional-images" />
        </div>
      </div>
      <div class="grey-container">
        <h3 id="strategy" class="left-titles">CHIEF STRATEGY OFFICER (CSO)</h3>
        <div class="row justify-content-evenly">
          <img src={salesFunnel} class="col-8 left-fractional-images" />
          <p class="col-4 fractional-text">
      ...
      <div class="blank-container">
        <h3 id="customer" class="right-titles">CHIEF CUSTOMER OFFICER (CCO)</h3>
        <div class="row justify-content-evenly">
          <p class="col-4 fractional-text">
          ...
          <img src={whiteIcons} class="col-8 right-fractional-images" />
        </div>
      </div>
